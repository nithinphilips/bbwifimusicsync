...
namespace LibQdownloader.Utilities
{
    public static class Common
    {
        ...
        /// Converts a size in bytes to human readable form (mb,gb,tb etc.)
        /// </summary>
        public static string ToReadableSize(double size, int precision)
        {
            ...
            if (sizeinbytes < 1024)
            {
                return negativeSign + sizeinbytes + " bytes";
            }
            if (sizeinbytes < 1048576)
            {
                return negativeSign + Math.Round((sizeinbytes / 1024d), precision) + " Kb";
            }
            if (sizeinbytes < 1073741824)
            {
                return negativeSign + Math.Round((sizeinbytes / 1048576d), precision) + " Mb";
            }
            if (sizeinbytes < 1099511627776)
            {
                return negativeSign + Math.Round((sizeinbytes / 1073741824d), precision) + " Gb";
            }
            if (sizeinbytes < 1125899906842624)
            {
                return negativeSign + Math.Round((sizeinbytes / 1099511627776d), precision) + " Tb";
            }
